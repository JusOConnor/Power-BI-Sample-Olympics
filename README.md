...
**Concept:**
One of the biggest design elements is the podium styled cards on the upper left corned.  Meant to resemble the podiums from the awards ceremony we have the total Gold, Silver, and Bronze medals awarded.  To avoid wasted space the Total Medal count was added to the center of the podium.  The three cards below change on each page to focus on more revelant stats.
...
![](/../main/Screenshots/NOC Summary.png)
