...
![Executive_Summary](Screenshots/Executive%Page.png)\
...
![Executive_Summary](Screenshots/NOC%20Summary.png)\
...
-The Events by Year stacked column chart highlights which year/s the Athlete competed in as well at the amount of events broken down by their results.\
     ...
     *Selecting from the Athletes Resuts visual*\
     ![List_Filtered](Screenshots/Athlete%Summary%-%List%Filtered.png)\
     *Utilizing the Search slicer to narrow down the list*\
     ![Search_Filtered](Screenshots/Athlete%Summary%-%Search%Filtered.png)\
